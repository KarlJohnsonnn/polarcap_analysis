...
def build_inventory(manifest_path: Path = MANIFEST) -> pd.DataFrame:
    ...
    rows: list[dict[str, object]] = [
        ...
        },
        {
            ...
            "artifact_type": "figure",
            "section": "results",
            "script": "scripts/analysis/growth/run_plume_lagrangian_evolution_slim.py",
            "config_or_args": "FigCfg in script (utilities.plume_lagrangian_slim.DEFAULT_CFG)",
            "output_path": "output/gfx/png/03/figure12_ensemble_mean_plume_path_slim.png",
            "caption": _load_script_caption("scripts/analysis/growth/run_plume_lagrangian_evolution_slim.py"),
            "draft_target": "manual figure include in article_draft/PolarCAP",
        },
        {
